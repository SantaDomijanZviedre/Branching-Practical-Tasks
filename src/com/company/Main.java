...
public class Main {
    ...
    static void practicalTaskNo2(long time) { /* OK, for Gods sake, this one I think I managed
    to make as I think it should be */
        ...
        static void practicalTaskNo3(/*int day, int month, int year*/) {
